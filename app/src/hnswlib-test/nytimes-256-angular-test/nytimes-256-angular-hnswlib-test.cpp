    ...
    for (int M : M_VALUES) {
        for (int ef_construction : EF_CONSTRUCTION_VALUES) {
            ...
            try {
                ...
                hnswlib::AngularSpace space(NYTIMES_256_DIM);
...
int main()
{
    try {
        ...
        std::string index_base_path = std::string(index_dir) + "hnswlib-test/nytimes-256-angular-test/nytimes-256-angular-test";
        std::string result_file_path = std::string(result_dir) + "hnswlib-test/nytimes-256-angular/nytimes-256-angular_recall_qps_result.csv";
